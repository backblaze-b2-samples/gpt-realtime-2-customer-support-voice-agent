...
const navItems = [
  // Primary CTA — the entry point for the voice-agent demo.
  { title: "Call", href: "/call", icon: PhoneCall },
  // Sample-specific Library view, scoped to the `calls/` prefix in B2.
  { title: "Calls", href: "/calls", icon: Headphones },
  { title: "Dashboard", href: "/", icon: LayoutDashboard },
  // Kept from the starter kit: operator-facing reference upload + full
  // bucket explorer. Not part of the primary user journey, but required
  // by the starter-kit contract.
    ...
    <Sidebar>
      <SidebarHeader className="border-b border-sidebar-border px-4 py-3.5">
        ...
        >
          ...
          <span>GPT-Realtime-2 Voice Agent</span>
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-gpt-realtime-2-customer-support-voice-agent"
          target="_blank"
